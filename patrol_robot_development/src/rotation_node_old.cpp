...
private:
    ...
    bool cond_goal;  // boolean to check if we still have to reach the goal or
                     // not
...
public:
    action() {
        ...
        sub_rotation_to_do = n.subscribe("rotation_to_do", 1,
                                         &action::rotation_to_doCallback, this);
    ...
    void init_rotation() {
        ...
        //  //       ROS_INFO("initial_orientation: %f provided by odometer",
        //  initial_orientation*180/M_PI);
        //   /*      cond_rotation = ( fabs(rotation_to_do) >
    ...
    void compute_rotation() {
        ...
        //  current_orientation*180/M_PI, initial_orientation*180/M_PI);
        ...
        if (cond_rotation) {
            ...
            if (current_rotation_speed < -rotation_speed_max)
                current_rotation_speed = -rotation_speed_max;
            ROS_INFO(
                "rotation_to_do: %f, rotation_done: %f, current_orientation: "
                "%f, initial_orientation: %f -> rotation_speed: %f",
